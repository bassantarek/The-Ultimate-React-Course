...
const pagesRange = book.pages > 1000 ? "Long book" : "Short book";
...
console.log(title, author, publicationDate, genres, hasMovieAdaptation);
console.log(`This book is ${pagesRange}`);
